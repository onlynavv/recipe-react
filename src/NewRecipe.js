        ...
        <div className='container'>
            <div className='newRecipe-wrapper'>
                ...
                <form className='form-wrapper' onSubmit={handleSubmit}>
                    ...
                    <div className='form-control'>
                        <InputLabel id="demo-simple-select-standard-label" className="userInput">Recipe Instructions</InputLabel>
                            ...
                            return(
                                <div className='instruction-div' key={index}>
                                    ...
                                    <div className="btn-box">
                                        ...
                                        {instructionList.length - 1 === index && <button onClick={handleInstructionAdd}>Add</button>}
                                    </div>
                                </div>
                            )
                        })}
                    ...
                    <div className='form-control'>
                        <InputLabel id="demo-simple-select-standard-label" className="userInput">Upload Recipe Photo</InputLabel>
